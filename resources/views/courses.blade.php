...
<div class="container">
                    ...
                    <div class="col-sm-7">
							<img class="img-fluid mt-5" src="{{asset('uploads/10fe9ebedcd2caab3945f9befe5c957d.jpeg')}}" alt="">
